...
export default function CurrenciesContent({
  ...
  return (
    <>
      <section className="flex min-h-screen w-full items-center justify-center bg-zinc-100">
      ...
      <section className="flex min-h-screen w-full items-center justify-center">
        <div className="flex w-300 items-center gap-16">
      ...
      <section className="flex h-screen w-full items-center justify-center gap-20 bg-[#6DA67A]">
        <picture>
          <Image
            className=""
            src={didYouKnow}
            ...
            alt="Coinzinho"
          />
          <Image src={littleCoin} width={500} height={500} alt="Coinzinho" />
        </picture>
        <div className="relative h-200 w-180">
          <Image src={bgCuriosity} alt="Coinzinho" fill />
          <div className="relative z-10 flex h-full flex-col justify-center gap-12 px-20">
            ...
            <ul className="list-inside list-disc columns-2 text-gray-800">
